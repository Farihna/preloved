<!-- ======= Header ======= -->
<header id="header" class="header fixed-top d-flex align-items-center" style="background-color: #000333;">

<div class="d-flex align-items-center justify-content-between">
  <a href="/" class="logo d-flex align-items-center">
    <img src="<?= base_url('img/logo_preloved_light.png')?>" alt="" class="image-fluid">
    <!-- <span class="d-none d-lg-block">Preloved-U</span> -->
  </a>
